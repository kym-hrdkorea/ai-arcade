...
- Draw Duel AI 추측: 서버 내부 `AIGuesser` 경계, 라운드당 1회 추측, AI 점수판/최종 결과 표시. 기본 mock, `DRAW_DUEL_AI_PROVIDER=openai`로 실제 그림 snapshot 기반 OpenAI vision 추측 지원 (timeout·retry·circuit breaker·mock fallback 포함)
